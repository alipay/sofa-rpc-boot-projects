 ...
 */
package com.alipay.sofa.rpc.samples.retry;
...
public class RetriesSample {
    ...
    public int start(ApplicationContext applicationContext) throws InterruptedException {
        ...
        return retriesServiceBolt.getCount();
    }
}